...
<body>
    ...
    <div class="card-panel z-depth-2">
            <textarea name="buat_ba">
                ...
                <p style="text-align: center; margin: 0px;"><span style="font-size: 10pt;">NO. {{$data->id_cr}}</span></p>
                <p style="text-align: center;"><span style="font-size: 12pt;"><strong>TENTANG</strong></span></p>
                <p style="text-align: center; margin: 0px;"><span style="font-size: 12pt;">{{$data->nama_customer}}</span></p>
                ...
                <ol>
                    <li><span style="font-size: 10pt;">Berdasarkan Nota Jasa Penumpukan dengan pemakaian jasa {{$data->nama_customer}} sebagai berikut: (nota terlampir).</span></li>
                </ol>
                <div class="tabel">
                    <table border="2" style="font-size:12px; border-collapse:collapse; width:100%;">
                        ...
                        <tbody>
                            ...
                            @foreach($data2 as $data2)
                                ...
                                <td class="aligcen">{{$data2->no_pengajuan}}</td>
                                <td class="aligcen">{{$data2->id_cr}}</td>
                                <td class="aligcen">{{$data2->jenis_nota}}</td>
                                <td class="aligcen">{{$data2->nota_lama}}</td>
                                <td class="aligcen">{{$data2->no_req}}</td>
                                <td class="aligcen">{{$data2->tagihan}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
