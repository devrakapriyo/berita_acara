...
<head>
    <title>IPC | Input Data Finance</title>
</head>
@section('content')
...
<body>
    ...
    <div class="card-panel z-depth-2">
        <form method="post" action="{{ URL::asset('inputfi') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <tr>
                            <th>Tagihan baru</th>
                            <th>:</th>
                            <th class="orange-text">Rp. {{$data->tagihan_baru}}</th>
                        </tr>
                        <tr>
                            <th>Selisih</th>
                            <th>:</th>
...
-->
                        <tr>
                            ...
                            <th>
                                <div class="input-field">
                                    <input name="jml_finance" class="blue-text" placeholder="Jumlah" type="text" value="Rp. {{$data->selisih}}">
                                </div>
                            </th>
                        </tr>
                </tbody>
                <tfoot>
                    <tr>
                        <th colspan="3">
                            <a href="{{URL::asset('detailinputfi')}}/{{$data->id_buat_ba}}" class="btn waves-effect orange darken-1" type="submit">Kembali
