...
@extends('dashboard')
<head>
	<title>IPC | Edit Detail Data {{$data->nama_customer}}</title>
</head>
@section('content')
<body>
	<ol class="breadcrumb">
        ...
        <li class="active">Barui data Finance</li>
    </ol>
    ...
    <div class="card-panel z-depth-2">
        <form method="post" action="{{ URL::asset('editdatafi') }}">
            ...
            <table class="highlight responsive-table">
                <thead>
                    <tr>
                        <th colspan="3">
                            <h5 class="blue-text">Perbarui data Finance</h5></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
...
<!--
    ...
    <th>:</th>
    <th>
        <input name="tanggal" value="{{$data->tgl_finance}}" type="date" class="datepicker" placeholder="Masukan Tanggal">
    </th>
</tr>
-->
                        <tr>
                            ...
                            <th>
                                <div class="input-field">
                                    <input name="jml_finance" value="{{$data->jml_finance}}" placeholder="Jumlah" type="text">
                                </div>
                            </th>
                        </tr>
                </tbody>
                <tfoot>
                    <tr>
                        <th colspan="3">
                            <a href="{{URL::asset('editdatafi')}}/{{$data->id_buat_ba}}" class="btn waves-effect orange darken-1" type="submit">Kembali
