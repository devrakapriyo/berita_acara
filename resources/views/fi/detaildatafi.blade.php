        ...
        <table class="highlight atas responsive-table">
            ...
            <tbody>
                ...
                <tr>
                    <th>Tagihan</th>
                    <th>:</th>
                    <th class="pink-text">Rp. {{$data->tagihan}}</th>
                </tr>
                <tr>
                    <th>Tagihan baru</th>
                    <th>:</th>
                    <th class="blue-text">Rp. {{$data->tagihan_baru}}</th>
                </tr>
                <tr>
                    <th>Selisih</th>
                    <th>:</th>
            ...
            <tfoot>
                <tr>
                    <th colspan="3" class="right-align">
                        <a href="{{URL::asset('detailinputfi')}}/{{$data->id_buat_ba}}" class="btn waves-effect orange">Kembali
