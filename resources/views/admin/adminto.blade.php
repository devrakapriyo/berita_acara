...
@extends('dashboard')
<head>
	<title>IPC | Admin Terminal Operasi</title>
</head>
@section('content')
<body>
<form method="post" action="{{URL::asset('simpanto')}}" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
<input type="hidden" name="jabatan" value="Terminal Operation">
<ol class="breadcrumb">
  <li><a href="{{URL::asset('admin')}}">Admin</a></li>
	<li><a href="{{URL::asset('admincs')}}">Admin Customer Service</a></li>
	<li class="active">Admin Terminal Operation</li>
