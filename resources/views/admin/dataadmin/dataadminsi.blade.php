...
@extends('dashboard')
<head>
	<title>IPC | Data Admin Sistem Informasi</title>
</head>
@section('content')
<body>
<ol class="breadcrumb">
	<li><a href="{{URL::asset('datadmin')}}">Admin</a></li>
...
<table class="highlight bordered atas responsive-table">
	...
	<tbody>
		...
		<tr>
			...
			<td class="center-align">
				<a href="{{URL::asset('editadminsi')}}/{{$data->id}}" title="Edit"><i class="material-icons">assignment</i></a>
			</td>
			<td class="center-align">
