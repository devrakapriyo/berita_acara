...
@extends('dashboard')
<head>
	<title>IPC | Data Admin Terminal Operasi</title>
</head>
@section('content')
<body>
<ol class="breadcrumb">
...
<table class="highlight bordered atas responsive-table">
	...
	<tbody>
		...
		<tr>
			...
			<td class="center-align">
				<a href="{{URL::asset('editadminto')}}/{{$data->id}}" title="Edit"><i class="material-icons">assignment</i></a>
			</td>
			<td class="center-align">
