...
@extends('dashboard')
<head>
	<title>IPC | Admin Finance</title>
</head>
@section('content')
<body>
<form method="post" action="{{URL::asset('simpanfi')}}" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
<input type="hidden" name="jabatan" value="Finance">
<ol class="breadcrumb">
  <li><a href="{{URL::asset('admin')}}">Admin</a></li>
	...
	<li class="active">Admin Finance</li>
