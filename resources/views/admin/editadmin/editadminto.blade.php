...
@section('content')
<body>
<form method="post" action="{{URL::asset('baruiadminto')}}" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{csrf_token()}}">
<input type="hidden" name="id" value="{{ $detail ->id }}">
<input type="hidden" name="jabatan" value="Terminal Operasi">
<blockquote>
    <h5>Perbarui data admin terminal operation</h5>
</blockquote>
